...
class DroneVisualization:
    def plot_routes(self, drones, deliveries, no_fly_zones, best_routes, title=None):
        # title parametresi opsiyonel, ama import edilen fonksiyona gönderilmiyor çünkü desteklemiyor
...
def main():
    ...
    try:
        ...
        # Burada title parametresi kaldırıldı, çünkü plot_routes desteklemiyor
